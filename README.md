...
The explorer is built to be driven live — in a classroom, a one-on-one, or a
team planning session. Walk the nine sliders one at a time, ask an honest
question per axis, and set the value:
